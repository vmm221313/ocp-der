...
class CGCNN_Evidential(BaseModel):
    ...
    def __init__(
        ...
        super(CGCNN_Evidential, self).__init__(num_atoms, bond_feat_dim, num_targets)
        ...
        self.units = units
        self.softplus = torch.nn.Softplus(beta=sotfplus_beta, threshold=softplus_threshold) 
    ...
    def _forward(self, data):
        ...
        mu, logv, logalpha, logbeta = torch.split(energy, split_size_or_sections=(1 * self.units), dim=-1)
